    ...
    <div className="flex px-[16px] lg:px-[60px] py-[40px]">
      <Grid container alignItems="center" spacing="20px">
        <Grid item lg={3} md={12} xs={12}>
          <div
            className="flex flex-row items-end gap-[8px] cursor-pointer"
            onClick={() =>
          ...
          >
            ...
            />
            <p className="typography-h200 dark:hover:text-base-light dark:text-base-light-active text-base-dark-active hover:text-base-light-active">
