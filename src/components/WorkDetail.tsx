        ...
        >
          ...
          <Grid item container xs={12} justifyContent="center" spacing="20px">
            <Grid item lg={5} md={6} xs={6}>
              <div
                className={`h-full flex flex-col py-[12px] pl-[18px] pr-[12px] rounded-[5px] border border-solid dark:border-base-light-active border-base-dark-active ${
                  work[dataIdx - 1]?.title
                    ? "dark:hover:bg-[#ffffff1a] hover:bg-base-light-hover cursor-pointer"
                    : ""
                }`}
                onClick={() =>
                  work[dataIdx - 1]?.id
              ...
              >
                ...
                <p className="typography-desc dark:text-grey-light-active text-base-dark-light text-right">
                  {work[dataIdx - 1]?.title ? work[dataIdx - 1]?.title : "-"}
                </p>
              </div>
            </Grid>
